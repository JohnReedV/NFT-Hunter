...
use web3::{api::Web3, transports::http::Http, types::{Block, H256, H160}};

pub async fn get_contract_address(web3: &Web3<Http>, blockdata: &Option<Block<H256>>) -> web3::Result<(web3::types::H160, Error)> {
